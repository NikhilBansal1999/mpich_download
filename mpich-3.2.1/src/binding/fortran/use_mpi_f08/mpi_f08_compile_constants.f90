...
! Datatypes
type(MPI_Datatype), parameter   :: MPI_COMPLEX         = MPI_Datatype(MPI_DATATYPE_NULL)
type(MPI_Datatype), parameter   :: MPI_DOUBLE_COMPLEX  = MPI_Datatype(MPI_DATATYPE_NULL)
type(MPI_Datatype), parameter   :: MPI_LOGICAL         = MPI_Datatype(MPI_DATATYPE_NULL)
type(MPI_Datatype), parameter   :: MPI_REAL            = MPI_Datatype(MPI_DATATYPE_NULL)
type(MPI_Datatype), parameter   :: MPI_DOUBLE_PRECISION = MPI_Datatype(MPI_DATATYPE_NULL)
type(MPI_Datatype), parameter   :: MPI_INTEGER         = MPI_Datatype(MPI_DATATYPE_NULL)
type(MPI_Datatype), parameter   :: MPI_2INTEGER        = MPI_Datatype(MPI_DATATYPE_NULL)
type(MPI_Datatype), parameter   :: MPI_2DOUBLE_PRECISION = MPI_Datatype(MPI_DATATYPE_NULL)
type(MPI_Datatype), parameter   :: MPI_2REAL           = MPI_Datatype(MPI_DATATYPE_NULL)
type(MPI_Datatype), parameter   :: MPI_CHARACTER       = MPI_Datatype(MPI_DATATYPE_NULL)
